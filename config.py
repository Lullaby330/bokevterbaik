...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5455750177:AAF2kbuvbizwHX9jhIcEYgC9gOHr9xfEjN")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "5158607797 1850233338 554575617").split()):
        ADMINS.append(int(x))
except ValueError:
